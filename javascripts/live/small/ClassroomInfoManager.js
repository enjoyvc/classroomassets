    ...
    onReceive : function(data){
        ...
        if(data.cmd == "classroom:join"){
            if(data.userid == userid){
                ...
                ClassroomInfoModule.instance.setHandPermission(data.controlpanel.switch_global_raise_hand_permission);                  //设置允许举手
//                ClassroomInfoModule.instance.setAllowHandupTime(60);                                                             //举手时间计时
            }else{
                if(!data.isReConnect)
            ...
            if(role == 2){
                ...
                ClassroomInfoModule.instance.setAllowHandup(data.status);
                ClassroomInfoModule.instance.setAllowHandupTime(data.time);
            }
    ...
    setHandPermission : function(value){
        //TODO::设置允许举手
    },
    setZonePermission : function(value){
        //TODO::设置讨论区发言
    },
